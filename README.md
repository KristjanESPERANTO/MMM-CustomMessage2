...
| Option                | Description
|-----------------------|------------
|`initialMessage`	|*Optional* A message you would like to display when MagicMirror loads<br>**Type:** `string` (accepts HTML elements)<br>**Default:** `"No notification received yet"`
